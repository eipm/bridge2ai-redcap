...
Say the following word 3 times: **smile**
...
Say the following word 3 times: **great**
...
Say the following word 3 times: **sled**
...
Say the following word 3 times: **slip**
...
Say the following word 3 times: **pants**
...
Say the following word 3 times: **bad**
...
Say the following word 3 times: **pinch**
...
Say the following word 3 times: **such**
...
Say the following word 3 times: **take**
...
Say the following word 3 times: **need**
...
Say the following word 3 times: **scab**
...
Say the following word 3 times: **five**
...
Say the following word 3 times: **class**
...
Say the following word 3 times: **mouth**
...
Say the following word 3 times: **me**
...
Say the following word 3 times: **fed**
...
Say the following word 3 times: **beef**
...
Say the following word 3 times: **fold**
...
Say the following word 3 times: **hunt**
...
Say the following word 3 times: **no**
...
Say the following word 3 times: **are**
...
Say the following word 3 times: **pond**
...
Say the following word 3 times: **teach**
...
Say the following word 3 times: **slice**
...
Say the following word 3 times: **tree**
