...
This document provides an overview of the Pediatric Disorders Protocol for Ages 10+ used in the Bridge2AI project. It includes details on questionnaires, and acoustic tasks relevant to the protocol.
